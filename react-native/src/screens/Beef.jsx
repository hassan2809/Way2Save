...
import HeroSection from '../../assets/images/beef_1.jpg';
// import HeroSection from '../../assets/images/beef_2.jpg';
        ...
        ListHeaderComponent={
          <View style={styles.heroSection}>
            ...
            <View style={styles.heroContent}>
              <Text style={styles.heroTitle}>Premium Halal Beef Cuts</Text>
              <Text style={styles.heroDescription}>
                Our beef is sourced from trusted halal-certified farms, ensuring the highest standards of quality and ethical practices.
              </Text>
            </View>
          </View>
        }
