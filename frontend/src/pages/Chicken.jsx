...
import Chicken1 from '../components/assets/chicken_1.jpg';
import Chicken2 from '../components/assets/chicken_2.jpg';
...
const Chicken = () => {
    ...
    useEffect(() => {
        const fetchProducts = async () => {
            try {
                const response = await axios.get('https://way2save.onrender.com/auth/products/chicken');
                ...
                <div className="container mx-auto px-4 py-16 flex flex-col lg:flex-row items-center gap-8">
                    <div className="relative w-full lg:w-1/2 h-[300px] lg:h-[400px] ml-8 md:ml-14 xl:ml-0">
                        <div className="absolute top-0 left-0 w-[80%] h-full rounded-3xl transform -rotate-6">
                            <img src={Chicken1} className="h-full w-full object-cover rounded-3xl" alt="" />
                        </div>
                        <div className="absolute top-0 left-[10%] w-[80%] h-full rounded-3xl transform rotate-6">
                            <img src={Chicken2} className="h-full w-full object-cover rounded-3xl" alt="" />
                        </div>
                    </div>

                    <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
                        <h1 className="text-4xl lg:text-5xl font-bold text-navy-900 leading-tight font-jost">
                            Premium Free-Range Organic Chicken
                        </h1>
                        <p className="text-lg text-gray-600 max-w-lg font-jost">
                            Our chicken is ethically raised in free-range environments, ensuring the highest quality, taste, and nutrition. Enjoy the natural flavor of organic, hormone-free chicken in every bite.
                        </p>
                    </div>
                </div>
            </div>
